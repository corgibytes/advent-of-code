  ...
  def result_length
    ...
    while removed_marker_input.length > 0 do
      ...
      if matched_marker.nil?
        ...
        # Grab next group of characters
        nested_day_nine = DayNinePartTwo.new(removed_marker_input[0...number_to_grab])
        total_length += nested_day_nine.result_length * repeat_count
...
# Grab the number to grab
# Start a new instance of DayNinePartTwo.new(new).result_length
